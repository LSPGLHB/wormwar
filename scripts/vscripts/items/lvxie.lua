...
function refreshItemBuff(keys,flag)
    ...
    local item_speed_duration = ability:GetSpecialValueFor( "item_speed_duration") --此处怎么处理
    ...
    local item_ability_speed_C_precent = ability:GetSpecialValueFor( "item_ability_speed_C_precent")
    local item_range_C = ability:GetSpecialValueFor( "item_range_C")
    local item_range_C_precent = ability:GetSpecialValueFor( "item_range_C_precent")
    local item_damage_C = ability:GetSpecialValueFor( "item_damage_C")
    local item_damage_C_precent = ability:GetSpecialValueFor( "item_damage_C_precent")
    local item_control_C_precent = ability:GetSpecialValueFor( "item_control_C_precent")
    local item_energy_C_precent = ability:GetSpecialValueFor( "item_energy_C_precent")
    local item_mana_cost_C_precent = ability:GetSpecialValueFor( "item_mana_cost_C_precent")
    local item_damage_match_C_precent = ability:GetSpecialValueFor( "item_damage_match_C_precent")
    local item_control_match_C_precent = ability:GetSpecialValueFor( "item_control_match_C_precent")
    ...
    setPlayerPower(playerID, "player_speed_precent", flag, item_speed_precent)
    ...
    setPlayerPower(playerID, "player_ability_speed_C_precent", flag, item_ability_speed_C_precent)
    setPlayerPower(playerID, "player_range_C", flag, item_range_C)
    setPlayerPower(playerID, "player_range_C_precent", flag, item_range_C_precent)
    setPlayerPower(playerID, "player_damage_C", flag, item_damage_C)
    setPlayerPower(playerID, "player_damage_C_precent", flag, item_damage_C_precent)
    setPlayerPower(playerID, "player_control_C_precent", flag, item_control_C_precent)
    setPlayerPower(playerID, "player_energy_C_precent", flag, item_energy_C_precent)
    setPlayerPower(playerID, "player_mana_cost_C_precent", flag, item_mana_cost_C_precent)
    setPlayerPower(playerID, "player_damage_match_C_precent", flag, item_damage_match_C_precent)
    setPlayerPower(playerID, "player_control_match_C_precent", flag, item_control_match_C_precent)
